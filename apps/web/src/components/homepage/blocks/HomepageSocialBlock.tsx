...
type Props = { block: HomepageSocialBlockView };

export function HomepageSocialBlock({ block }: Props) {
  const links =
    block.links && block.links.length > 0 ? block.links : [...DEFAULT_LINKS];
